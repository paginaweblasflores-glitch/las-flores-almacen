...
export default function DateSearch() {
  ...
  return (
    <div className="flex flex-col gap-5">
      <div>
        <h1 className="text-2xl font-bold text-stone-900">Movimientos por Fecha</h1>
        <p className="text-sm text-stone-400 mt-0.5">Consulta los movimientos dentro de un período</p>
      </div>

      <form onSubmit={handleSearch} className="bg-white border border-stone-200 rounded-lg p-5 flex flex-wrap gap-4 items-end">
        ...
        <button type="submit" className="px-5 py-2 bg-stone-900 text-white text-sm font-semibold rounded-lg hover:bg-stone-800 transition-colors h-[38px]">
          Consultar
        </button>
      </form>
