          ...
          <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-xs">
            <div className="flex items-start justify-between gap-4 flex-wrap">
              ...
              <div className="flex gap-4 text-center">
                ...
                <div className="flex flex-col">
                  <span className="text-2xl font-bold text-slate-700">S/ {item.valor.toFixed(2)}</span>
            ...
            {rows.map((r) => (
              <tr key={r.id} className="hover:bg-slate-50/60 transition-colors">
                <td className="px-3 py-2.5 text-right font-mono text-slate-700">{r.cantidad}</td>
                  <td className="px-3 py-2.5 text-right font-mono text-slate-600">S/ {r.valor.toFixed(2)}</td>
