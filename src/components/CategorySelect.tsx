    ...
    <>
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          disabled={disabled}
          className="px-2.5 py-2 bg-sky-50 hover:bg-sky-100 text-sky-700 border border-sky-200 hover:border-sky-300 rounded-lg text-xs font-semibold flex items-center gap-1 transition-all cursor-pointer shadow-2xs whitespace-nowrap active:scale-95 disabled:opacity-50"
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-[60] bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-4 animate-in fade-in duration-150">
          <div className="bg-white rounded-2xl max-w-md w-full p-5 sm:p-6 shadow-2xl border border-slate-200 flex flex-col gap-4">
            <div className="flex items-center justify-between border-b border-slate-100 pb-3">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <h3 className="text-base font-bold text-slate-900">Crear Categoría</h3>
                  <p className="text-xs text-slate-400">Añade una nueva categoría para organizar productos</p>
                </div>
              </div>
              <button
                type="button"
            ...
            <form onSubmit={handleCreateCategory} className="flex flex-col gap-4">
              <div className="flex flex-col gap-1.5">
                <label htmlFor="modal-categoria-nombre" className="text-xs font-semibold text-slate-600 uppercase tracking-wide">
              ...
              <div className="flex items-center justify-end gap-2.5 pt-2 border-t border-slate-100">
                ...
                <button
                  type="submit"
                  className="px-4 py-2 text-xs font-semibold bg-sky-600 hover:bg-sky-700 active:bg-sky-800 text-white rounded-lg transition-colors cursor-pointer flex items-center gap-1.5 shadow-xs"
                >
                  <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
